 ...
 *
 * @link https://roostergrin.com
 *
 * @package rg
 */

if ( ! function_exists( 'rg_setup' ) ) :
/**
...
function rg_setup() {
  ...
  add_theme_support( 'custom-background', apply_filters( 'rg_custom_background_args', array(
